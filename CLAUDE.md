...
- 六位數代碼只做 short authentication string 驗證，絕不能直接作為 encryption key 或在網路上傳送。
...
| Transport | Network.framework TCP + TLS |
| Pairing | Ephemeral Curve25519 + six-digit SAS + long-term pinned identity |
